...
isa_ok $added, 'UID2::Client::Timestamp';
...
my $epoch = 1642775407;
my $from_epoch_second = UID2::Client::Timestamp->from_epoch_second($epoch);
isa_ok $from_epoch_second, 'UID2::Client::Timestamp';
is $from_epoch_second->get_epoch_second, $epoch;
is $from_epoch_second->get_epoch_milli, $epoch * 1000;

my $from_epoch_milli = UID2::Client::Timestamp->from_epoch_milli($epoch * 1000);
isa_ok $from_epoch_milli, 'UID2::Client::Timestamp';
